    ...
    (function (t) {
      ...
      function r() {
        t(".navbar-fullscreen-links a").click(function (e) {
          ...
          t(".navbar-fullscreen").removeClass("active"),
            setTimeout(function () {
              location.href = n;
            }, 1e3);
        });
    ...
    !(function (e, n) {
      ...
      function O(t, e) {
        ...
        if (1 === e.nodeType) {
          if (
            Ft.hasData(t) &&
            ((r = Ft.access(t)), (s = Ft.set(e, r)), (u = r.events))
          ) {
          ...
          for (i in d)
            l ||
              (m
                ...
                : (m = Ft.access(t, "fxshow", { display: u })),
              r && (m.hidden = !g),
              g && w([t], !0),
              p.done(function () {
      ...
      var Ct = (function (t) {
        ...
        try {
          Q.apply((Y = J.call(H.childNodes)), H.childNodes),
                    ...
                    ? function (t, e) {
                        ...
                        return (
                          ...
                          (!x.sortDetached &&
                            ...
                            ? t === j || (t.ownerDocument === H && q(H, t))
                              ? -1
                              : e === j || (e.ownerDocument === H && q(H, e))
                              ? 1
                              : D
                              ? K(D, t) - K(D, e)
                              : 0
        ...
        yt.fn.extend({
          ...
          hasClass: function (t) {
            var e,
              ...
              i = 0;
            for (e = " " + t + " "; (n = this[i++]); )
              if (1 === n.nodeType && (" " + J(K(n)) + " ").indexOf(e) > -1)
                return !0;
            return !1;
          },
        });
